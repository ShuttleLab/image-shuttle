        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <a
              ...
              className="hidden sm:inline-flex rounded-lg p-2 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground items-center justify-center"
              aria-label="GitHub"
            >
